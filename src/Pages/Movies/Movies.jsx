...
const Movies = () => {
  ...
  const fetchMovies = async () => {
    const { data } = await axios.get(
      `https://api.themoviedb.org/3/discover/movie?api_key=dc72c666c72eb1ba78c1a070e26b9dd8&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${pageNumber}&with_genres=${genreforURL}`
    );
  ...
  const getIdForCarousel = (id) => {
    let media_type;
    let finalResult = { id, media_type: "movie" };
